...
export default function Theme() {
  const { themeMode, actualTheme } = useGlobalTheme();
  ...
  return (
    ...
    >
      <div className="p-6 bg-background text-foreground min-h-screen">
        <h1 className="text-2xl font-bold mb-6 text-foreground">Theme Settings</h1>
        <Card>
          <CardHeader>
          ...
          <CardContent>
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-muted-foreground">Current theme: {themeMode}</p>
                <p className="text-sm text-muted-foreground">Active: {actualTheme}</p>
              </div>
              <GlobalThemeToggle />
            </div>
          </CardContent>
