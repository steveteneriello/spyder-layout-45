...
const LocationBuilderBackup = () => {
  ...
  const menuItems = [
    ...
    { title: "Location Builder Backup", path: "/location-builder-backup", icon: "map-pin", section: "Tools" },
      ...
      nav={
        <div className="flex items-center justify-between w-full px-6">
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-xl font-semibold tracking-wide text-white">Tools (Backup)</h1>
          </div>
        </div>
      }
      category={
        <div className="flex items-center space-x-2 text-white/80 text-sm">
          ...
          <span>Location Tools Backup</span>
        </div>
      }
      footer={
        ...
        <div className="bg-gradient-to-r from-slate-50 to-white border-b border-slate-200 shadow-sm p-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-xl font-semibold tracking-wide text-slate-900">Location List Builder (Backup)</h1>
            </div>
          </div>
...
export default LocationBuilderBackup;
