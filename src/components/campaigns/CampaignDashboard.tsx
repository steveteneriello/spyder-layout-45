      ...
      <div style={{ backgroundColor: '#444444' }} className="p-6 rounded-lg mb-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {Array.from({ length: 4 }).map((_, i) => (
            <div key={i} style={{ backgroundColor: '#121212', borderColor: '#444444' }} className="border rounded-lg">
              <div className="p-6">
                <div className="animate-pulse">
                  <div style={{ backgroundColor: '#444444' }} className="h-4 rounded w-3/4 mb-2"></div>
                  <div style={{ backgroundColor: '#444444' }} className="h-8 rounded w-1/2"></div>
                </div>
              </div>
            </div>
          ))}
          ...
          return (
            ...
            >
              <div className="flex flex-row items-center justify-between space-y-0 pb-2 p-6">
                <div className="text-sm font-medium" style={{ color: '#B0B0B0' }}>
                  {card.title}
                </div>
